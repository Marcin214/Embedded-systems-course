#define MAX_TOKEN_NR 						5        	//maksymalna dopuszczalna ilosc tokenów
#define MAX_KEYWORD_NR 					5         // maksymalna liczba komend
...
typedef enum { CALIB, GOTO, ID, STATE, BUTTON} KeywordCode;
